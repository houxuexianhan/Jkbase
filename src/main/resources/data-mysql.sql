...
INSERT INTO sys_app (AppID, A_AppDesc, A_AppName, A_AppUrl, A_IsSys, A_Version) VALUES (1,'设置集成的应用及其功能模块23ab','框架应用系统','',1,'1.0'),(2,'应用系统管理及其功能模块','应用系统管理','',1,'1.0'),(3,'海师财务系统','海师财务系统','http://www.xxx.xxx',0,'1.0'),(5,'海师教务系统的权限控制管理','海师教务系统','http://www.xxx.xxx',0,'1.0'),(6,'海师新生报到系统','海师新生报到系统','http://www.xxx.xxx',0,'1.0');
...
INSERT INTO sys_company (CompanyID, C_AreaId, C_ChildCount, C_CName, C_Level, C_ParentID, C_ShowOrder) VALUES (1,21,0,'机关部门',1,0,1),(3,21,0,'教辅部门',1,0,1),(4,21,0,'发展与改革研究中心',2,3,1),(6,2,0,'车站2',2,5,32),(7,3,0,'琼海车站2',3,6,33),(8,21,0,'教学学院',1,0,1),(13,21,0,'附属单位',1,0,4),(14,21,0,'挂靠单位',1,0,5),(15,21,0,'校办企业',1,0,6),(16,21,0,'其他部门',1,0,8),(17,21,0,'党政办公室',2,1,1),(18,21,0,'组织部',2,1,2),(19,21,0,'党委宣创部',2,1,3),(20,21,0,'教育科学研究院',2,3,2),(21,21,0,'学报编辑部',2,3,3),(22,21,0,'图书馆',2,3,4),(23,21,0,'心理学院',2,8,1),(26,21,0,'党政办公室',2,14,1),(27,21,0,'学生工作部',2,14,2),(28,21,0,'教师工作部',2,14,3),(29,21,0,'党政领导班子',3,23,1),(30,21,0,'教学系',3,23,2),(31,21,0,'科研机构',3,23,3),(32,21,0,'治理机构',3,23,4),(33,21,0,'办公室',3,23,5),(34,21,0,'学术委员会',4,32,1),(35,21,0,'教学督导委员会',4,32,2),(36,21,0,'教学委员会',4,32,3),(37,21,0,'学院党委组织',4,32,4),(38,21,0,'工会组织',4,32,5),(39,21,0,'教代会',4,32,6),(40,21,0,'学代会',4,32,7);
/*!40000 ALTER TABLE sys_company ENABLE KEYS */;

--
-- Dumping data for table `sys_company_role`
--
-- ORDER BY:  Companyid,Roleid

/*!40000 ALTER TABLE sys_company_role DISABLE KEYS */;
INSERT INTO sys_company_role (Companyid, Roleid) VALUES (3,2),(3,3),(3,4),(4,7),(20,4);
/*!40000 ALTER TABLE sys_company_role ENABLE KEYS */;
...
INSERT INTO sys_field (FieldID, F_CName, F_Remark) VALUES (1,'常用语','常用短语，便于用户输入，如：审核通过等。'),(2,'计量单位','常用计量单位，如个、件等。'),(3,'牌照颜色','车辆牌照颜色，蓝色、黄色、黑色、白色四种'),(4,'行政区域划分','中国可分为8个大区: 华北、东北、华东、华中、华南、西北、西南、港澳台'),(5,'行政区域级别','省、自治区、直辖市、行政区、地级市、县级市、县、自治县、乡、镇');
...
INSERT INTO sys_module (ModuleID, M_AppID, M_CName, M_Code, M_Icon, M_IsClose, M_OrderLevel, M_ParentID, M_URL) VALUES (1,1,'框架系统','frm','fa fa-square-o',0,'0000',0,''),(2,1,'应用与模块管理','ModuleMng','fa fa-square',0,'0001',1,'frm/ModuleMng/module.page'),(4,1,'字段类型管理','FieldMng','fa fa-tag',0,'0004',1,'frm/FieldMng/module.page'),(5,1,'系统异常日志','SystemErrorLog','fa fa-file',1,'0005',1,'frm/SystemErrorLog/module.page'),(7,2,'系统管理','sys','fa fa-asterisk',0,'0000',0,''),(8,2,'行政区管理','AreaMng','fa fa-map-o',0,'0002',7,'sys/AreaMng/module.page'),(9,2,'组织机构管理','CompanyMng','fa fa-tree',0,'0003',7,'sys/CompanyMng/module.page'),(10,2,'角色应用权限','RoleMng','fa fa-key',0,'0006',7,'sys/RoleMng/module.page'),(11,2,'用户管理','UserMng','fa fa-user',0,'0004',7,'sys/UserMng/module.page'),(12,2,'数据字典','FieldValueMng','fa fa-book',0,'0001',7,'sys/FieldValueMng/module.page'),(13,2,'事件日志查询','EventMng','fa fa-sticky-note-o',0,'0007',7,'sys/EventMng/module.page'),(14,2,'系统参数管理','SystemParam','fa fa-cogs',0,'0008',7,'sys/SystemParam/module.page'),(16,2,'部门角色管理','OnlineUser','fa fa-street-view',0,'0005',7,'sys/CompanyRoleMng/module.page'),(48,2,'角色用户管理','RoleUserMng','fa fa-user-secret',0,'0005',7,'sys/RoleUserMng/module.page'),(61,1,'功能管理','FunctionMng','fa fa-envira',0,'0002',1,'frm/FunctionMng/module.page'),(64,3,'海师子系统22','advMng','fa fa-bell',0,'2001',0,''),(66,3,'子系统管理22','VideoMng','fa fa-video-camera',0,'2003',64,'subsys/subsysMng/module.page'),(67,3,'广告系统','','fa fa-television',0,'2101',0,''),(68,3,'发布文本通知','TextPublish','fa fa-file-text-o',0,'2102',67,'subsys/subsysMng/module.page'),(69,3,'发布图片通知','ImagePublish','fa fa-picture-o',0,'2103',67,'Advertising/ImagePublish/module.page'),(70,3,'发布视频通知','VideoPublish','fa fa-video-camera',0,'2104',67,'Advertising/VideoPublish/module.page'),(71,3,'清除通知','Clear','fa fa-eraser',0,'2105',67,'Advertising/Clear/module.page'),(72,3,'发布检票班次','CheckPublish','fa fa-bus',0,'2106',67,'Advertising/CheckPublish/module.page');
...
INSERT INTO sys_role (RoleID, R_Description, R_RoleName) VALUES (2,'SYS_MNG_GROUP','系统管理组'),(3,'aaa','角色A'),(4,'bbb','角色C'),(7,'dddxxx','角色B');
/*!40000 ALTER TABLE sys_role ENABLE KEYS */;

--
-- Dumping data for table `sys_role_app`
--
-- ORDER BY:  A_RoleID,A_AppID

/*!40000 ALTER TABLE sys_role_app DISABLE KEYS */;
INSERT INTO sys_role_app (A_RoleID, A_AppID) VALUES (1,1),(2,2),(2,3),(4,3),(7,3);
/*!40000 ALTER TABLE sys_role_app ENABLE KEYS */;

--
-- Dumping data for table `sys_role_module`
--
-- ORDER BY:  P_RoleID,P_ModuleID

/*!40000 ALTER TABLE sys_role_module DISABLE KEYS */;
INSERT INTO sys_role_module (P_RoleID, P_ModuleID, P_Value) VALUES (2,8,63),(2,9,63),(2,10,31),(2,11,31),(2,12,15),(2,13,1),(2,14,3),(2,48,511),(2,66,0),(2,68,3),(2,69,0),(2,70,0),(2,71,0),(2,72,1),(3,66,38),(3,68,0),(3,69,0),(3,70,0),(3,71,0),(3,72,0),(7,66,39),(7,68,3),(7,69,3),(7,70,387),(7,71,7),(7,72,1);
...
INSERT INTO sys_user (UserId, U_CName, U_CompanyID, U_Disabled, U_Expired, U_Email, U_JoinTime, U_LastIp, U_LastTime, U_LoginName, U_MobileNo, U_PhotoUrl, U_Pwd, U_Salt, U_Status, U_Type) VALUES (1,'超级管理员',4,0,0,'','2015-06-10 10:26:15.000000','10.10.10.89','2016-06-15 11:07:19','admin','','/resources/upload/user/image/15209958046719763_.jpg','e33c9532a8b8239bef1980e57f8a6bb3','9e77501e-725f-4d69-812e-56b0c2186f11',0,0),(2,'测试A',1,0,0,'779878329@qq.com','2020-09-23 10:20:55.186000',NULL,NULL,'aa','',NULL,'e33c9532a8b8239bef1980e57f8a6bb3','f3366bc8-a353-4ef3-a0db-13848c1966ff',0,2),(3,'测试C',4,0,0,'',NULL,NULL,NULL,'cc','',NULL,'e33c9532a8b8239bef1980e57f8a6bb3',NULL,0,2);
/*!40000 ALTER TABLE sys_user ENABLE KEYS */;

--
-- Dumping data for table `sys_user_role`
--
-- ORDER BY:  R_UserID,R_RoleID

/*!40000 ALTER TABLE sys_user_role DISABLE KEYS */;
INSERT INTO sys_user_role (R_UserID, R_RoleID) VALUES (2,2),(2,4),(2,7),(3,2),(3,7);
